...
coco_input_path = Path(f"{exp_data_root}/datasets/{dataset_name}-coco/train/_annotations.coco_repair.json")
yolo_output_path = Path(f"{exp_data_root}/error_anno/{dataset_name}/yolo_format/repair/data.yaml")
