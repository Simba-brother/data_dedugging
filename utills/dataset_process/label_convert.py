...
coco_input_path = Path("/data/mml/data_debugging_data/datasets/KITTI_8-coco/train/_annotations.coco_repair_datactive.json")
yolo_output_path = Path("/data/mml/data_debugging_data/error_anno/KITTI_8/yolo_format/repair_datactive/data.yaml")
