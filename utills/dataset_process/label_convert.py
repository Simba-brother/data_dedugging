...
coco_input_path = Path("/data/mml/data_debugging_data/datasets/VisDrone-coco/train/_annotations.coco_repair_ours_YOLOv7_new_alpha=1.3.json")
yolo_output_path = Path("/data/mml/data_debugging_data/error_anno/VisDrone/yolo_format/repair_ours/with_topsis/new_alpha=1.3/data.yaml")
