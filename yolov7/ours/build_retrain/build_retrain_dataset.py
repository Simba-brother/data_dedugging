...
if __name__ == "__main__":
    ...
    source_labels_dir = "/data/mml/data_debugging_data/Results/datactive/KITTI_8/YOLOv7/exp_01/retrain/label_split/total_labels"
    # 切出的train labels dir
    target_train_labels_dir = "/data/mml/data_debugging_data/Results/datactive/KITTI_8/YOLOv7/exp_01/retrain/label_split/splitted_labels/train"
    # 切出的val labels dir
    target_val_labels_dir = "/data/mml/data_debugging_data/Results/datactive/KITTI_8/YOLOv7/exp_01/retrain/label_split/splitted_labels/val"
    extract_labels()
