...
if __name__ == "__main__":
    ...
    source_labels_dir = "/data/mml/data_debugging_data/Results/clean/VisDrone/labels/yolo_format/labels"
    # 切出的train labels dir
    target_train_labels_dir = "/data/mml/data_debugging_data/Results/clean/VisDrone/label_split/train"
    # 切出的val labels dir
    target_val_labels_dir = "/data/mml/data_debugging_data/Results/clean/VisDrone/label_split/val"
    extract_labels()
