...
if __name__ == "__main__":
    ...
    coco_anno_json_path = Path("/data/mml/data_debugging_data/Results/ours/VOC2012/YOLOv7/exp_01/repair/_annotations.coco_repair.json")
    yolo_output_dir = Path("/data/mml/data_debugging_data/Results/ours/VOC2012/YOLOv7/exp_01/repair/yolo_format")
